...
const text = computed(() => zh.value ? {
  ...
  boundaryText: '单 4090 支持纯文字或一至三张参考图生成五秒 MP4，双 3080 也支持多参考图完整生成。提供 Python、容器命令和官方权重编译器；HTTP 服务使用条件包到 latent 的接口。',
  inputs: '了解运行前提',
  next: '按你的任务开始',
  guides: [
  ...
  boundaryText: 'Generate a five-second MP4 from text or up to three references on one 4090. A pair of 3080s also supports complete multi-reference generation through Python or Docker. The HTTP service uses conditioning bundles and returns latents.',
