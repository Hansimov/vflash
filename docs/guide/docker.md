...
These instructions build `vflash:0.1.0a4` locally from your checkout. The first build downloads the pinned runtime dependencies. Model resources stay mounted read-only; outputs and kernel caches use separate writable storage.
