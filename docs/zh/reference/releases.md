...
当前版本为 **0.1.0a6**，面向开发者的 H3 去噪预览版。公开接口接收预编译条件包，输出视频与音频 latent 张量。选择配置前，请先查看[支持列表](../guide/profiles)。
...
公开包支持列表中的 **BF16 Ref2VA Turbo4 / Turbo8 和 SM89 T2VA Turbo4 配置**。W8 量化、实时提示词与参考素材编码、MP4 输出均不是已发布能力。运行资源包和面向使用者的准备命令尚未公开。
