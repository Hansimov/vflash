...
The public package currently supports the listed **BF16 Ref2VA Turbo4/Turbo8 profiles**. W8 quantization, T2VA, live prompt/reference encoding and MP4 output are not released capabilities. Runtime assets and an end-user preparation command are not yet published.
